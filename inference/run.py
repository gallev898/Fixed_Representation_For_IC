...
# section: paths
coco_data_path = output_folder_path if args.run_local else '/yoav_stg/gshalev/image_captioning/output_folder'
...
if __name__ == '__main__':
    ...
    for i, (image, caps, caplens, allcaps) in tqdm(enumerator):
        ...
        if not None == seq_sum_:
            generated_sentences_likelihood.append((i, seq_sum_))

        if args.run_local and i == 50:
            break
